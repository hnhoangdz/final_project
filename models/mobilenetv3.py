...
class Model(nn.Module):
    ...
    '''
    def __init__(self, in_channels, mode='small', num_classes=1000, input_size=224, width_multiplier=1.0, dropout=0.2, BN_momentum=0.1, zero_gamma=False):
        '''
...
if __name__ == "__main__":
    import time
    import numpy as np
    model = Model(num_classes=7, input_size=48)
    model.eval()
